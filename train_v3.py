...
print("Original training:", x_train_full.shape)
...
print("Augmented training:", x_train.shape)
...
with open("results/train_v3_metrics.txt", "w") as f:
...
plt.tight_layout()
plt.savefig("results/train_v3_history.png", dpi=300)
plt.show()
